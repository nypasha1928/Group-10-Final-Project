function StrokevsHypertension() {
  // Name for the visualisation to appear in the menu bar.
  this.name = 'Stroke vs Hypertension';

  // Each visualisation must have a unique ID with no special
  // characters.
  this.id = 'Stroke vs Hypertension';
  ...
  this.layout = {
    ...
    this.setup = function () {
      ...
      var xValue = ['Hypertension', 'NO Hypertension'];
      var yValue = ['10.75%', '89.25%'];
      ...
      var trace = {
        ...
        hoverinfo: ['10.75%', '89.25%'],
        marker: {
          color : ['Moccasin', 'DarkGreen']
        },
      ...
      var layout = {
        title: '11% of the Stroke cases had Hypertension',
        size : 14,
        barmode : 'stack',
        // xaxis: {title: "Age"},
